...
- [ ] **EU AI Act Art 50(2) — machine-readable AI marking.** Embed an
  ...
  The transparency chapter applies from **2026-08-02**. Plan task T25; the
  *visible* label half is done (see below), this is the remaining
  machine-readable half — best generated by the backend when it builds the
  translated EPUB. **Priority:** P1 (before public launch / 2026-08-02).
